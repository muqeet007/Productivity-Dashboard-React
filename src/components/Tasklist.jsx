...
const TaskList = () => {
  return (
    <aside className="h-screen w-120 flex flex-col p-4  bg-green-50 mt-1">
      {/* Heading */}
      <div className="relative flex justify-between items-center h-20 mb-6">
       <div>
         <h2 className=''>
          <span className="text-black text-2xl font-tertiary ">
            Tasks 
          </span>
          
          <span className="space-x-0.5 text-greeno text-2xl text-bold font-tertiary">
            &#45;List
          </span>
