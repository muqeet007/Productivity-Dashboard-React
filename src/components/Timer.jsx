...
const Timer = () => {
  return (
    <div className="flex flex-col bg-green-50 items-center border-3 border-white w-screen">
        {/* Dynamic text */}
      <h3 className="text-2xl font-extrabold font-secondary text-black">
        Pomodoro Timer
      </h3>

     <div className="w-full border border-white/30 backdrop-blur-md bg-white/20 rounded-xl shadow-lg p-4">
        ...
        <div className="text-8xl font-number text-greeno mt-10 border-2 text-center">
          1:00
        </div>
